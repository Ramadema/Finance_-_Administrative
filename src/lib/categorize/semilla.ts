...
export const SEMILLA: readonly EntradaSemilla[] = [
  ...
  // ---------- Ocio y viajes ----------
  { patron: "CINEMARK", comercio: "Cinemark", categoria: "ocio", subcategoria: "Entretenimiento" },
  { patron: "HOYTS", comercio: "Hoyts", categoria: "ocio", subcategoria: "Entretenimiento" },
  { patron: "VILLAGE CINE", comercio: "Village Cines", categoria: "ocio", subcategoria: "Entretenimiento" },
  { patron: "CINEPOLIS", comercio: "Cinépolis", categoria: "ocio", subcategoria: "Entretenimiento" },
  { patron: "TICKETEK", comercio: "Ticketek", categoria: "ocio", subcategoria: "Entretenimiento" },
  { patron: "PASSLINE", comercio: "Passline", categoria: "ocio", subcategoria: "Entretenimiento" },
  { patron: "DESPEGAR", comercio: "Despegar", categoria: "ocio", subcategoria: "Viajes" },
  { patron: "BOOKING", comercio: "Booking.com", categoria: "ocio", subcategoria: "Hotelería" },
  { patron: "AIRBNB", comercio: "Airbnb", categoria: "ocio", subcategoria: "Hotelería" },
  { patron: "AEROLINEAS", comercio: "Aerolíneas Argentinas", categoria: "ocio", subcategoria: "Viajes" },
  { patron: "FLYBONDI", comercio: "Flybondi", categoria: "ocio", subcategoria: "Viajes" },
  { patron: "JETSMART", comercio: "JetSmart", categoria: "ocio", subcategoria: "Viajes" },
  { patron: "LATAM", comercio: "LATAM", categoria: "ocio", subcategoria: "Viajes" },
  { patron: "UDEMY", comercio: "Udemy", categoria: "ocio", subcategoria: "Educación" },
  { patron: "PLATZI", comercio: "Platzi", categoria: "ocio", subcategoria: "Educación" },
  { patron: "COURSERA", comercio: "Coursera", categoria: "ocio", subcategoria: "Educación" },
  { patron: "UADE", comercio: "UADE", categoria: "ocio", subcategoria: "Educación" },
